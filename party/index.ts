...
const PROMPTS: Prompt[] = [
  ...
  { id: "b24", text: "Do you think you are above average intelligence?", type: "binary" },
  { id: "b25", text: "Have you ever cheated on a test or exam?", type: "binary" },
  { id: "b26", text: "Do you think money can buy happiness?", type: "binary" },
  { id: "b27", text: "Have you ever slid into someone's DMs and gotten a response?", type: "binary" },
  { id: "b28", text: "Do you make your bed every morning?", type: "binary" },
  { id: "b29", text: "Have you ever been dumped by text?", type: "binary" },
  { id: "b30", text: "Would you move to a different country for a partner?", type: "binary" },
  { id: "b31", text: "Have you ever drunk-texted an ex?", type: "binary" },
  { id: "b32", text: "Do you think you could go vegan for a month?", type: "binary" },
  { id: "b33", text: "Have you ever lied on your resume?", type: "binary" },
  { id: "b34", text: "Do you think you are a good cook?", type: "binary" },
  { id: "b35", text: "Have you ever pretended to be sick to avoid plans?", type: "binary" },
  { id: "b36", text: "Do you think you could win a trivia night?", type: "binary" },
  { id: "b37", text: "Have you ever been on a blind date?", type: "binary" },
  { id: "b38", text: "Would you rather be famous than rich?", type: "binary" },
  { id: "b39", text: "Have you ever cried at a movie in public?", type: "binary" },
  { id: "b40", text: "Do you think you could live without social media for a year?", type: "binary" },
  ...
  { id: "mc24", text: "Which era would you most want to live in?", type: "multiple_choice", options: ["1920s", "1970s", "1990s", "Far future"] },
  { id: "mc25", text: "What would your friends say is your biggest flaw?", type: "multiple_choice", options: ["Too stubborn", "Too flaky", "Too blunt", "Too sensitive"] },
  { id: "mc26", text: "How would you rather spend a free Saturday?", type: "multiple_choice", options: ["Hiking outdoors", "Brunching with friends", "Gaming or Netflix", "Exploring a new city"] },
  { id: "mc27", text: "Which describes your relationship with the gym?", type: "multiple_choice", options: ["I live there", "I go sometimes", "I pay but don't go", "What gym?"] },
  { id: "mc28", text: "What would you do with an unexpected $10,000?", type: "multiple_choice", options: ["Invest it", "Travel", "Pay off debt", "Spend it immediately"] },
  ...
  { id: "mc36", text: "Which would stress you out most?", type: "multiple_choice", options: ["Public speaking", "Job interview", "First date", "Meeting the parents"] },
  { id: "mc37", text: "How punctual are you?", type: "multiple_choice", options: ["Always early", "Right on time", "A little late", "Fashionably late always"] },
  ...
  { id: "s19", text: "How much of a risk-taker are you in life?", type: "scale", labelLow: "Play It Safe", labelHigh: "All In" },
  { id: "s20", text: "How much do you care about what others think of you?", type: "scale", labelLow: "Not At All", labelHigh: "A Lot" },
  { id: "s21", text: "How often do you exercise?", type: "scale", labelLow: "Never", labelHigh: "Every Day" },
  { id: "s22", text: "How competitive are you?", type: "scale", labelLow: "I Just Have Fun", labelHigh: "Must Win" },
  { id: "s23", text: "How often do you text first?", type: "scale", labelLow: "Never", labelHigh: "Always" },
  { id: "s24", text: "How messy is your phone's camera roll right now?", type: "scale", labelLow: "Organized", labelHigh: "Total Chaos" },
  { id: "s25", text: "How good are you at keeping secrets?", type: "scale", labelLow: "I'll Tell Everyone", labelHigh: "Fort Knox" },
  { id: "s26", text: "How much do you enjoy small talk?", type: "scale", labelLow: "Hate It", labelHigh: "Love It" },
  { id: "s27", text: "How often do you check your horoscope?", type: "scale", labelLow: "Never", labelHigh: "Daily" },
  { id: "s28", text: "How much do you spend on going out per month?", type: "scale", labelLow: "Nothing", labelHigh: "Way Too Much" },
  ...
  { id: "s30", text: "How comfortable are you with confrontation?", type: "scale", labelLow: "Avoid At All Costs", labelHigh: "Bring It On" },
  { id: "s31", text: "How much of a procrastinator are you?", type: "scale", labelLow: "Always Ahead", labelHigh: "Last Minute Always" },
  { id: "s32", text: "How often do you apologize first in an argument?", type: "scale", labelLow: "Never", labelHigh: "Always" },
  { id: "s33", text: "How materialistic are you?", type: "scale", labelLow: "Minimalist", labelHigh: "Love Nice Things" },
  { id: "s34", text: "How often do you romanticize your life?", type: "scale", labelLow: "Never", labelHigh: "All The Time" },
  { id: "s35", text: "How much do you trust your gut feelings?", type: "scale", labelLow: "Ignore Them", labelHigh: "Always Follow" },
  { id: "s36", text: "How often do you feel like you have your life together?", type: "scale", labelLow: "Never", labelHigh: "Totally" },
];
